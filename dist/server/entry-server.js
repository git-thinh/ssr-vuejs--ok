...
const _sfc_main$9 = /* @__PURE__ */ Object.assign(__default__$3, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.ssrRenderAttrs(_attrs)} data-v-0a55a2c6><nav data-v-0a55a2c6>`);
      ...
      _push(`</nav><h1 data-v-0a55a2c6>App Main: ${serverRenderer.ssrInterpolate(_ctx.count)}</h1><button data-v-0a55a2c6>update</button><hr data-v-0a55a2c6>`);
...
var App = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-0a55a2c6"]]);
